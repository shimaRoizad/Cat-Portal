...
<div class="topnav">
  ...
  <a href="sitevisit.php">Site Visit</a>
   ...
   <div class="table-responsive">  
    ...
    ?>        
            <tr>
                <td><?php echo $rows['tt_num']; ?></td>
                <td><?php echo $rows['trans_state']; ?></td>
                <td><?php echo $rows['trans_zone']; ?></td>
                <td><?php echo $rows['remark_ctt']; ?></td>
            </tr>
    <?php     
        }
    ?>
