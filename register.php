			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" id="name" type="text" name="username" value="<?php echo $username;?>" placeholder="Enter username">
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" id="mail" type="text" name="email" value="<?php echo $email;?>" placeholder="Enter email@tm.com">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						<span class="label-input100">Password</span>
						<input class="input100" id="psword" type="password" name="password_1"  placeholder="Enter password">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						<span class="label-input100">Confirm Password</span>
						<input class="input100" id="cpassword" type="password" name="password_2"  placeholder="Enter password">
						<span class="focus-input100"></span>
					</div>
